...
class Prot_Model(nn.Module):
    def __init__(self,):
        ...
        self.tokenizer_pro = BertTokenizer.from_pretrained("ESM", do_lower_case=False)
        self.model_pro = BertModel.from_pretrained("ESM")
...
class MyModel(nn.Module):
    def __init__(self,):
        ...
        self.fc_class1 = nn.Linear(256, 2)
    ...
    def forward(self, inputs,inputs2):
        ...
        # output_cnn_pro,lstm_output_pro=self.prot_based(inputs)
        x=output_cnn_esm+lstm_output_esm
...
model.to(device)
learning_rates=0.000055 #Setting learning rates
