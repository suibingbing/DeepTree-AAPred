...
class ESM_Model(nn.Module):
    ...
    def forward(self, inputs):
        ...
        outputs_esm_last=pad_tensor_to_shape(outputs_esm_last,(16, 400, 480))
...
class Prot_Model(nn.Module):
    def __init__(self,):
        ...
        self.bilstm2 = nn.LSTM(self.model_pro.config.hidden_size, 512, num_layers=1, bidirectional=False)
        self.dropout = nn.Dropout(0.2)
        self.fc_pro = nn.Linear(3564, 512)  
...
class MyModel(nn.Module):
    def __init__(self,):
        ...
        self.fc_class1 = nn.Linear(2048, 2)
